...
"will I finish _this_ block in time to start the next one?" — not when the whole
...
- **Arrival time clarity**: one idea is the sticky clock always shows the _current_
