...
1.  **Create Task List:**
    ...
    - _Constraint:_ Initially, the list will be sequential.
2.  **View Arrival Time:**
    - As a user, I want to see a prominent "Arrival Time" that calculates the finish time of the _remaining_ tasks based on the current time.
