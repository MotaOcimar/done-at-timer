...
*   **Focus-First:** The primary view when a timer is running should be the current task and the *predicted completion time*.
...
*   **Gamified Feedback:**
    ...
    *   **Progress:** A clear visual representation of progress through the *entire list*, not just the current task (e.g., a progress bar filling up as the "Arrival Time" draws nearer).
...
## 3. Tone of Voice
*   **Persona:** **The Supportive Coach.**
*   **Tone:** Encouraging, positive, and helpful. It should frame time management as a tool for freedom, not a source of stress.
*   **Copy Examples:**
    *   *Instead of:* "You are late." -> *Try:* "Let's adjust! New arrival time: 14:45."
    *   *Instead of:* "Task expired." -> *Try:* "Done with [Task]? Great job! Next up..."
    *   *Instead of:* "Start." -> *Try:* "Let's Go!" or "Focus."

## 4. Accessibility
*   **High Contrast:** Ensure text and key elements are easily readable against their backgrounds.
*   **Clear Visual Cues:** Use more than just color to indicate status (e.g., icons + color) to support users with color vision deficiencies.
