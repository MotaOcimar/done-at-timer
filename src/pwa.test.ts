...
describe('PWA Build verification', () => {
  ...
  it.runIf(distExists)(
    'should generate a valid manifest.webmanifest in the dist directory',
    () => {
  ...
  it.runIf(distExists)(
    'should include PWA meta tags in dist/index.html',
    () => {
      ...
      expect(indexHtml).toContain(
        '<meta name="apple-mobile-web-app-title" content="Done-At" />',
      );
      expect(indexHtml).toContain(
  ...
  it.runIf(distExists)(
    'should generate a service worker with precaching in the dist directory',
    () => {
