...
export const InstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:right-auto md:left-4 md:w-80 bg-white p-4 rounded-xl shadow-2xl border border-slate-200 z-50 duration-300">
      <div className="flex items-center gap-3">
        ...
        {!isIOS && (
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-lg shadow-blue-500/30 active:scale-95 cursor-pointer"
          >
            Install
          </button>
        )}
