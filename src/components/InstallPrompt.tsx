      ...
      <div className="flex items-center gap-3">
        ...
        {!isIOS && (
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors shadow-lg shadow-blue-500/30 active:scale-95 cursor-pointer"
          >
            Install
          </button>
        )}
