    ...
    <div className="space-y-2">
      ...
      {allCompleted && (
        <div className="mb-6 animate-in fade-in zoom-in duration-500">
          <button
            onClick={() => resetTasks()}
            className="w-full bg-white border-2 border-green-500 text-green-600 py-4 rounded-2xl font-bold text-lg hover:bg-green-50 transition-all shadow-md shadow-green-50 flex items-center justify-center gap-2"
          >
